...
func main() {
	...
	case time.Thursday:
		fmt.Println("Thursday's child is full of go")
	case time.Friday:
		fmt.Println("Friday's child is full of loving and giving")
	case time.Saturday:
		fmt.Println("Saturday's child is full of works hard for a living")
	case time.Sunday:
