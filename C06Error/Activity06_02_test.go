...
func TestValidateRoutingNumber(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			name:          "Error occurs",
			routingNumber: 99,
			wantedError:   func(t *testing.T, err error) bool { return err == ErrInvalidRoutingNum06_02 },
		},
		{
			name:          "No Error",
			routingNumber: 101,
...
func TestValidateLastName(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			lastName:    "",
			wantedError: func(t *testing.T, err error) bool { return err == ErrInvalidLastName06_02 },
		},
		{
