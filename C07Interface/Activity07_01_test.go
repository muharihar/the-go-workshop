...
func TestPay(t *testing.T) {
	...
	t.Log("Details TestCases:")
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			d := Developer07_01{Individual: Employee07_01{Id: 1, FirstName: tc.inputFirst, LastName: tc.inputLast}, HourlyRate: tc.inputHourlyRate, HoursWorkedInYear: tc.inputHoursWorkedInYear, Review: nil}
...
func TestFullName(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			d := Developer07_01{Individual: Employee07_01{Id: 1, FirstName: tc.fname, LastName: tc.lname}}
			gotName := d.FullName()
...
func TestManagerPay(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			m := Manager07_01{Individual: Employee07_01{Id: 2, FirstName: tc.inputFirst, LastName: tc.inputLast}, Salary: tc.inputSalary, CommissionRate: tc.inputCommissionRate}
